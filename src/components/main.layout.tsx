...
export function MainLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className={`grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] ${inter.className}`}>
            <div className="hidden border-r bg-muted/40 md:block">
                <div className="flex h-full max-h-screen flex-col gap-2">
                    <div className="flex h-14 items-center justify-center px-4 lg:h-[100px] lg:px-6">
                        ...
                        >
                            <Image src="/images/logoCLT.png" width={100} height={100} priority={true}  alt='Logo CLT'/>
                        </Link>
                    </div>
